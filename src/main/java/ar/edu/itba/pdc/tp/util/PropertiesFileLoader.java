...
public class PropertiesFileLoader {
	...
	static public Properties loadPropertiesFromFile(String propFileName)
	...
	private static Properties preparePropertyForReading(Properties property,
			String resourcePath) {
	...
	private static void validateFileInputStream(InputStream fileInputStream,
			String resourcePath) throws FileNotFoundException {
		if (fileInputStream == null) {
			String msg = "Could not find property file in path: "
					+ resourcePath;
			throw new FileNotFoundException(msg);
		}
	}

	private static void loadProperties(Properties property,
	...
	private static void validatePropertyFileName(String propFileName) {
		assert propFileName.getClass() == "string".getClass()
				&& propFileName != null;
	}
}